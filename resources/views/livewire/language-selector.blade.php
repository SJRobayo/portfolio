...
<div class="top-buttons">
    <div class="language-selector">
        ...
        <div id="lang-menu" class="lang-menu">
            <button class="lang-option" data-lang="fr" wire:click="changeLocale('{{ 'en' }}')">
                <x-flag-language-en class="flag" />
            </button>

            <button class="lang-option" data-lang="fr" wire:click="changeLocale('{{ 'es' }}')">
                <x-flag-language-es class="flag" />

            </button>
            <button class="lang-option" data-lang="fr" wire:click="changeLocale('{{ 'fr' }}')">
